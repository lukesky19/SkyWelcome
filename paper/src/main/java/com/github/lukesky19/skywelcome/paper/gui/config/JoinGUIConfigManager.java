...
/**
 * This class manages the join GUI configuration for the selecting a join message.
 */
public class JoinGUIConfigManager extends SimpleConfigManager<GUIConfig> {
    /**
     * Constructor
     * @param plugin An {@link ISkyPlugin} instance.
     */
    public JoinGUIConfigManager(@NonNull ISkyPlugin plugin) {
        super(plugin, Path.of(plugin.getDirectoryFile() + File.separator + "guis" + File.separator + "join.yml"), GUIConfig.class);
    }
                ...
                new GUIConfig.GuiData(
                        ...
                        new GUIConfig.PlaceholderButtons(
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<green>This is your current join message.</green>"),
                                        null,
                                        null,
                                        List.of(),
                                ...
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<yellow>Click to change to this join message.</yellow>"),
                                        null,
                                        null,
                                        List.of(),
                                        new ItemStackConfig.PotionConfig(null, List.of()),
                                ...
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<red>You do not have permission to use this join message.</red>"),
                                        null,
                                        null,
                                        List.of(),
                                        new ItemStackConfig.PotionConfig(null, List.of()),
    ...
    public void loadConfiguration() {
        ...
        try {
            ...
            if(joinConfig == null) {
                logger.warn(AdventureUtility.deserialize("Failed to load join.yml."));
                return;
            }
            ...
            if(!validateConfiguration(migratedConfiguration)) {
                logger.warn(AdventureUtility.deserialize("Join GUI configuration validation failed."));
                return;
            }

            this.configuration = migratedConfiguration;
        } catch (ConfigurateException configurateException) {
            logger.error(AdventureUtility.deserialize("Failed to load the join GUI configuration. Error: " + configurateException.getMessage()));
        }
    }
