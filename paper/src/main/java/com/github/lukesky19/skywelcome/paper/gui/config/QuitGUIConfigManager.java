...
/**
 * This class manages the join GUI configuration for the selecting a leave message.
 */
public class QuitGUIConfigManager extends SimpleConfigManager<GUIConfig> {
    /**
     * Constructor
     * @param plugin An {@link ISkyPlugin} instance.
     */
    public QuitGUIConfigManager(@NonNull ISkyPlugin plugin) {
        super(plugin, Path.of(plugin.getDirectoryFile() + File.separator + "guis" + File.separator + "quit.yml"), GUIConfig.class);
    }
    ...
    public void loadConfiguration() {
        ...
        try {
            ...
            GUIConfig quitConfig = root.get(GUIConfig.class);
            if(quitConfig == null) {
                logger.warn(AdventureUtility.deserialize("Failed to load quit.yml."));
                return;
            }

            GUIConfig migratedConfiguration = migrateConfiguration(quitConfig);

            // Check if the configuration is invalid
            if(!validateConfiguration(migratedConfiguration)) {
                logger.warn(AdventureUtility.deserialize("Quit GUI configuration validation failed."));
                return;
            }

            this.configuration = migratedConfiguration;
        } catch (ConfigurateException configurateException) {
            logger.error(AdventureUtility.deserialize("Failed to load the quit GUI configuration. Error: " + configurateException.getMessage()));
        }
    }
                ...
                new GUIConfig.GuiData(
                        ...
                        new GUIConfig.PlaceholderButtons(
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<green>This is your current leave message.</green>"),
                                        null,
                                        null,
                                        List.of(),
                                ...
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<yellow>Click to change to this leave message.</yellow>"),
                                        null,
                                        null,
                                        List.of(),
                                        new ItemStackConfig.PotionConfig(null, List.of()),
                                ...
                                new ItemStackConfig(
                                        ...
                                        null,
                                        null,
                                        List.of("<red>You do not have permission to use this leave message.</red>"),
                                        null,
                                        null,
                                        List.of(),
                                        new ItemStackConfig.PotionConfig(null, List.of()),
