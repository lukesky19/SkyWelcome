 ...
 * @param changeEnabled The message sent when the sending of the player's change message is enabled.
 * @param changeDisabled The message sent when the sending of the player's change message is disabled.
...
public record Locale(
        ...
        String motdEnabled,
        String motdDisabled,
        String changeEnabled,
        String changeDisabled,
